...
new_ai_service = """import { database } from '../../lib/firebase';
...
with open("frontend/src/services/ai/AIService.ts", "w", encoding="utf-8") as f:
    f.write(new_ai_service)

print("AIService rebuilt with Gemini integration.")
