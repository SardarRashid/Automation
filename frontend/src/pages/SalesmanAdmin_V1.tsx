...
export type UserRole = 'IT_ADMIN' | 'SALES_SUPERVISOR' | 'INVENTORY_SUPERVISOR' | 'MANAGER' | 'INVOICE_CLERK' | 'SALESMAN' | 'STOREKEEPER' | 'ADMIN' | 'SALESPERSON';
...
export const getDefaultPermissions = (role: UserRole | string): UserPermissions => {
  ...
  } else if (role === 'INVENTORY_SUPERVISOR' || role === 'STOREKEEPER') {
    p.inventory = true;
    p.scanner = true;
  }
...
export const hasAccess = (user: User | null, permissionKey: string): boolean => {
